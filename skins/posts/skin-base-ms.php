<?php
namespace Elementor_Skins_Posts_MS\Posts;
...
use Elementor_Skins_Posts_MS\Posts\Skin_Base_MS as Skin_Base_MS;
...
abstract class Skin_Base_MS extends Elementor_Skin_Base {
	...
	protected function _register_controls_actions() {
		...
		add_action( 'elementor/element/posts/section_query/after_section_start', [ $this, 'register_additional_ms_query_control' ] );
		add_action( 'elementor/element/posts/section_query/after_section_end', [ $this, 'register_style_sections' ] );
	}

	/**
	* Add custom query control for multisite site ID
	* TODO : replace with select
	**/
	public function register_additional_ms_query_control() {
		$this->add_control(
			'ms_site_id',
			[
				'label' => __( 'Site ID', 'elementor-pro' ),
	...
	public function render() {
		...
		if ( $this->get_instance_value( 'ms_site_id' ) ) {
			switch_to_blog( $this->get_instance_value( 'ms_site_id' ) );
		}
